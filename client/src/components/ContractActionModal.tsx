...
type ActionType = "settle" | "approve" | "reject" | "recede" | "dispute";
...
export const ContractActionModal = ({
  ...
  const handleConfirm = () => {
    if (actionType === "reject" || actionType === "dispute" || actionType === "recede") {
      onConfirm({ reason });
    } else {
      onConfirm();
    }
    ...
    switch (actionType) {
      case "settle":
        return {
          ...
          description: "You're about to initiate the settlement process. The counterparty will need to approve this settlement.",
          requiresInput: false,
      ...
      case "approve":
        return {
          ...
          description: "You're about to approve the settlement. This will complete the contract and release the funds.",
          requiresInput: false,
      ...
      case "reject":
        return {
          ...
          description: "Please provide a reason for rejecting this contract. This action cannot be undone.",
          requiresInput: true,
      ...
      case "dispute":
        return {
          ...
          title: "Open Dispute",
          description: "Please provide detailed information about the issue. A dispute resolution process will be initiated.",
          requiresInput: true,
